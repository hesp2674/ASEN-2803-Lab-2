...
figure(1)
plot(theta_exp_5pt5,v_mod_5pt5);
xlabel('Theta (deg)');
...
ylim([-200,300]);
hold on
plot(theta_exp_6pt5,v_mod_6pt5);
legend('Exp','Model');
...
ylim([-200,300]);
hold on
plot(theta_exp_7pt5,v_mod_7pt5);
legend('Exp','Model');
...
ylim([-200,300]);
hold on
plot(theta_exp_8pt5,v_mod_8pt5);
legend('Exp','Model');
...
ylim([-200,300]);
hold on
plot(theta_exp_9pt5,v_mod_9pt5);
legend('Exp','Model');
...
ylim([-200,300]);
hold on
plot(theta_exp_10pt5,v_mod_10pt5);
legend('Exp','Model');

figure(8)
plot(time_5pt5,(v_exp_5pt5-v_mod_5pt5));
xlabel('Time (s)');
ylabel('Residuals (cm/s)');
title('Residual vs Time for 5.5V');

figure(9)
plot(time_6pt5,(v_exp_6pt5-v_mod_6pt5));
xlabel('Time (s)');
ylabel('Residuals (cm/s)');
title('Residual vs Time for 6.5V');

figure(10)
plot(time_7pt5,(v_exp_7pt5-v_mod_7pt5));
xlabel('Time (s)');
ylabel('Residuals (cm/s)');
title('Residual vs Time for 7.5V');

figure(11)
plot(time_8pt5,(v_exp_8pt5-v_mod_8pt5));
xlabel('Time (s)');
ylabel('Residuals (cm/s)');
title('Residual vs Time for 8.5V');

figure(12)
plot(time_9pt5,(v_exp_9pt5-v_mod_9pt5));
xlabel('Time (s)');
ylabel('Residuals (cm/s)');
title('Residual vs Time for 9.5V');

figure(13)
plot(time_10pt5,(v_exp_10pt5-v_mod_10pt5));
xlabel('Time (s)');
ylabel('Residuals (cm/s)');
